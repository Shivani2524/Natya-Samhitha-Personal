          ...
          <div className="flex-1 overflow-y-auto py-8 px-5 scrollbar-hide space-y-10">
            ...
            {sortedSessions.length > 0 && (
              <div className="space-y-4">
                <h2 className="px-2 text-[0.6rem] font-nav tracking-[0.25em] text-[var(--gold-bright)]/80 flex items-center gap-2 whitespace-nowrap uppercase">
                  ...
                  {sortedSessions.map((session) => (
                    <button
                      ...
                      className="
                        ...
                        text-[var(--text-cream)]/90 hover:text-[var(--gold-bright)]
                        hover:bg-[var(--glass-gold)]/30
                        transition-all duration-200
                      "
                    >
                      <Clock className="w-3.5 h-3.5 mt-0.5 opacity-60 group-hover:opacity-100 shrink-0 transition-opacity" />
